...
class ParkinsonDataset(Dataset):
    def __init__(self, subject_list, max_samples_per_subject=50):
        self.samples = []
...
train_dataset = ParkinsonDataset(train_subjects, 50)
...
population = [[random.random(), random.random(), random.random(), random.uniform(0.5,0.85)] for _ in range(20)]
...
# SAVE
# =====================
torch.save(model1.state_dict(), "model7.pth")
torch.save(model2.state_dict(), "model8.pth")
torch.save(model3.state_dict(), "model9.pth")
